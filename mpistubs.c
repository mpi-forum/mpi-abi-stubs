...
static int initialized(int *flag)
{
  if (flag) *flag = is_initialized;
  return 0;
}

static int finalized(int *flag)
{
  if (flag) *flag = is_finalized;
  return 0;
}

static int get_version(int *version, int *subversion)
{
...
static int abi_get_version(int *abi_major, int *abi_minor)
{
...
static int get_library_version(char *version, int *resultlen)
{
...
int MPI_Abi_get_version(int *abi_major, int *abi_minor) { return abi_get_version(abi_major, abi_minor); }
...
int MPI_Finalized(int *flag) { return finalized(flag); }
...
int MPI_Get_library_version(char *version, int *resultlen) { return get_library_version(version, resultlen); }
int MPI_Get_processor_name(char *name, int *resultlen) { abort(); return 0; }
int MPI_Get_version(int *version, int *subversion) { return get_version(version, subversion); }
...
int MPI_Initialized(int *flag) { return initialized(flag); }
...
int MPI_Request_get_status_all(int count, const MPI_Request array_of_requests[], int *flag, MPI_Status *array_of_statuses) { abort(); return 0; }
int MPI_Request_get_status_any(int count, const MPI_Request array_of_requests[], int *indx, int *flag, MPI_Status *status) { abort(); return 0; }
int MPI_Request_get_status_some(int incount, const MPI_Request array_of_requests[], int *outcount, int array_of_indices[], MPI_Status *array_of_statuses) { abort(); return 0; }
